...
export default function Estate({updateValidationState}:IProps) {
    ...
    return (
        <div className='flex flex-col gap-4'>
            <MwebInput
                ...
                isDisabled={false}
                placeHolderText=''
                inputValue={addressDetails.estateName}
                handleChange={(value) => onHandleChange("estateName", value)}
                errorText={addressDetails.estateName.length === 0? 'This field is required': ''}
                helperText={''} />
        <MwebInput
            id={`estate-street-address`}
